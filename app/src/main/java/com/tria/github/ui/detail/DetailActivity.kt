...
import com.tria.github.adapter.SectionsPagerAdapter
import com.tria.github.data.Result
import com.tria.github.data.local.entity.UserEntity
import com.tria.github.databinding.ActivityDetailBinding
...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.imageTintList = ContextCompat.getColorStateList(this, R.color.red)
                        ...
                        when (result) {
                            ...
                            is Result.Success -> {
                                ...
                                with(binding) {
                                    ...
                                    fab.setImageResource(if (user.isFavorite) R.drawable.fav else R.drawable.fav_bd)
                                }
                            }
                            is Result.Error -> {
                                binding.progressBar.visibility = View.GONE
